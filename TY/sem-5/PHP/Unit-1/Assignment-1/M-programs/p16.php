...
<body>
    <div class="container">
        ...
        if (isset($_POST['check']) && isset($_POST['no1']) && is_numeric($_POST['no1'])) {
            ...
            if ($original == $sum) {
                echo '<div class="result yes"><strong>' . $original . '</strong> IS an Armstrong Number.</div>';
            } else {
                echo '<div class="result no"><strong>' . $original . '</strong> is NOT an Armstrong Number.</div>';
            }
        }
        ?>
    </div>
