...
class Program23 {
    public static void main(String args[]) {
        ...
        try {
            ...
            System.out.println("Invalid input! Please provide numeric values for principal, rate and time.");
        }
    }
}
/* 
 ...
 * (If invalid argument): Invalid input! Please provide numeric values for principal, rate and time.
 */
